(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../boolean/maximum", "@dikac/t-function/assert/callback-arguments", "./throwable/maximum", "../number/size"], factory);
    }
    ...
    function Maximum(value, maximum, inclusive, converter = size_1.default, error = maximum_2.default) {
        ...
        callback_arguments_1.default(value, guard, error, [maximum, inclusive, converter]);
    }
