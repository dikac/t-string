(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../boolean/minimum", "@dikac/t-function/assert/callback-arguments", "./throwable/minimum", "../number/size"], factory);
    }
    ...
    function Minimum(value, minimum, inclusive, converter = size_1.default, error = minimum_2.default) {
        ...
        callback_arguments_1.default(value, guard, error, [minimum, inclusive, converter]);
    }
