...
export default class Maximum<MessageT> implements Validator<string, string, MaximumValidatable<MessageT>>, Message<Function<[Readonly<Value<string> & Inclusive & MaximumNumber & Validatable>], MessageT>>, MaximumNumber, Inclusive {
    maximum: number;
    inclusive: boolean;
    ...
    validate<Argument extends string>(value: Argument): Return<string, Argument, string, MaximumValidatable<MessageT>>;
}
