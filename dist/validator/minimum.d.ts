...
export default class Minimum<MessageT> implements Validator<string, string, boolean, boolean, MinimumValidatable<string, MessageT>>, Message<Function<[Readonly<Value<string> & Inclusive & MinimumNumber & Validatable>], MessageT>>, MinimumNumber, Inclusive {
    minimum: number;
    inclusive: boolean;
